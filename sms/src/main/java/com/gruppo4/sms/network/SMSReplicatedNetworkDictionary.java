...
import com.gruppo4.communication.network.ReplicatedNetworkDictionary;
 ...
 */
public class SMSReplicatedNetworkDictionary<RK, RV> implements ReplicatedNetworkDictionary<SMSPeer, RK, RV> {
